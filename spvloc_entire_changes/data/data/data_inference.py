...
class Structured3DPlans_Inference(Dataset):
    ...
    def __getitem__(self, idx, room_id=None):
        ...
        print("scene['limits']:", scene["limits"])
        print("self.config.TEST.CAMERA_HEIGHT:", self.config.TEST.CAMERA_HEIGHT)
        print("floor:", floor)
        print("step:", pose_sample_step if pose_sample_step > 0 else self.config.TEST.POSE_SAMPLE_STEP)
        ...
        print("####################### sampled_poses_and_rooms: ", sampled_poses_and_rooms)
        print("####################### scene[\"materials\"]: ", scene["materials"])
...
def prepare_pano_renderings(config, sampled_poses_and_rooms, scene):
    ...
    print("####################### sampled_poses_and_rooms:",sampled_poses_and_rooms)
    print("####################### scene[\"materials\"]:",scene["materials"])
    print("####################### scene[\"materials_clipped\"]:",scene["materials_clipped"])
    #raise ValueError("AMOGUS")
